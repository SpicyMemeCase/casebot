...
const BOT_TOKEN = require('NDQ1OTc5MjY3Mjc3Mzg5ODI0.DeUM9A.HgGXEAMbJJeGbOIzEu-jz6OmsMc');
const PREFIX = require('c!');
const GOOGLE_API_KEY = require('AIzaSyANgMz7ZMhuYhTFHUJTNhdzuQRqsiGYXHk');
